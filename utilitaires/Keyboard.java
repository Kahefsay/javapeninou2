...
/************************************************************
    Classe Keyboard offrant des services de saisie de données au clavier 
    de type de base ainsi que String.<BR>
    Saisie d'une valeur avec retour chariot en fin de saisie.<BR>
    Propose un service de temporisation (attente d'une saisie sans retour de valeur).<BR>
<BR>
	Paramétrage :<BR>
        - arrêt ou continuation en cas d'erreur durant la saisie
          (pas de valeur saisie ou valeur erronée).<BR>
<BR>
	Défaut :<BR>
...
final public class Keyboard
{
    ...
    **********************************/
    ...
    // Attributs
    private static BufferedReader streamReadIn =
    ...
    private static void testContinueOnReadError()
    {
        ...
        {
            System.out.println("Arret sur erreur durant la saisie dans la classe Keyboard ...");
            System.exit(10001);
        }
    }
    ...
    {
        System.out.println("Arret car erreur sur flot d'entrée dans la classe Keyboard ...");
        System.exit(10002);
    }
 ...
 * En cas d'erreur de saisie, suivant le paramètrage de la classe, attend une nouvelle saisie ou arrête l'application.<BR>
...
/**
 * Permet de temporiser l'affichage en attendant la frappe de la touche return.<BR>
 */
...
/**
 * Permet de temporiser l'affichage en attendant la frappe de la touche return.<BR>
 * Affiche la chaine <CODE>message</CODE> avant d'attendre la frappe de la touche return.<BR>
 * @param		message		La chaîne de caractère à afficher pour l'attente (String).
 */
...
/**
 * Permet de paramétrer la classe pour continuer à attendre une valeur correcte en cas d'erreur de saisie (même répétée).<BR>
 * @see         Keyboard#setStopOnReadError() setStopOnReadError
 */
...
/**
 * Permet de paramétrer la classe pour arrêter l'application en cas d'erreur de saisie.<BR>
 * @see         Keyboard#setContinueOnReadError()  setContinueOnReadError
 */
